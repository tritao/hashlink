...
static hl_runtime_status hl_runtime_module_load_manifest_internal( hl_code *code, const unsigned char *bytes, int length,
	...
	*out = NULL;
	...
	if( owned_code != NULL ) hl_code_free_function_data(code);
...
static hl_runtime_status hl_runtime_module_load_code_internal( hl_code *code, const unsigned char *bytes, int length, const unsigned char *identity,
	...
	return hl_runtime_module_load_manifest_internal(code,bytes,length,&manifest,out,initialize,haxe_metadata,owned_code,code_owned);
}
...
hl_runtime_status hl_runtime_module_load_haxe_metadata( hl_code *code, const unsigned char *bytes, int length, const unsigned char *module_id,
	...
	return hl_runtime_module_load_manifest_internal(code,bytes,length,&manifest,out,false,true,NULL,NULL);
}
...
hl_runtime_status hl_runtime_module_apply_haxe_patch( hl_runtime_module *runtime, hl_patch_input *input, int haxe_type_count,
